    	...
    	<div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
				  	<h2>管理员注册</h2>
					    <form method="post" action="servlet/RegisterA">
						   
					    	<div>
						    	<span><label>管理员名</label></span>
						    	<span><input name="admin_name" type="text" class="textbox" ></span>
						    </div>
					    	<div>
						    	<span><label>密码</label></span>
						    	<span><input name="admin_password" type="password" class="textbox" ></span>
						    </div>
