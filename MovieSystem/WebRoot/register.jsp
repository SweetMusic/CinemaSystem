 ...
 <div class="main">
     ...
     <div class="content">
     	<div class="content_top">
    		...
    		<p><a href="index.jsp">Home</a> &gt;&gt;&gt;&gt; <a href="#" class="active">Contact</a></p>
    	    </div>
    		<div class="clear"></div>
    	</div>
    	<div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
				  	<h2>用户注册</h2>
					    <form method="post" action="servlet/RegisterU">
						    <div>
						    	<span><label>手机号码</label></span>
						    	<span><input name="user_tel" type="text" class="textbox"></span>
						    </div>
					    	<div>
					    	...
					    	<div>
						    	...
						    	<span><input name="user_password" type="password" class="textbox" ></span>
						    </div>
						    <div>
						    	<span><label>性别</label></span>
						    	<span><input name="user_sex" type="text" class="textbox" ></span>
						    </div>
						    <div>
						     	<span><label>年龄</label></span>
						    	<span><input name="user_age" type="text" class="textbox"></span>
						    </div>
						    <div>
						     	<span><label>生日</label></span>
						    	<span><input name="user_birthday" type="text" class="textbox"></span>
						    </div>
						    <div>
						     	<span><label>身份证</label></span>
						    	<span><input name="user_idcard" type="text" class="textbox"></span>
						    </div>
						   <div>
						   		<span><input type="submit" value="确定"  class="mybutton"></span>
						  </div>
					    </form>
				  </div>
  				</div>
