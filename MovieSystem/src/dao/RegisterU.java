...
public class RegisterU extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UserRegister(user, out, response);
		//tag
		
		
	}

	public void UserRegister(User user, PrintWriter out, HttpServletResponse response)
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				{
					out.print("fali");
					response.sendRedirect("/MovieSystem/register.jsp");
					break;
				}
				else if(rs.isLast())
				{
